	...
	function _processNodeProcessCryptocurrencyBlockchainWorkerSettings($parameters, $response) {
		...
		while (true) {
			...
			foreach ($nodeProcessCryptocurrencyBlockchainWorkerSettings as $nodeProcessCryptocurrencyBlockchainWorkerSetting) {
				...
				$nodeProcessCryptocurrencyBlockchainWorkerHashSpeedLog = _list(array(
					'data' => array(
				...
				$nodeProcessCryptocurrencyBlockchainWorkerHashSpeedLog = current($nodeProcessCryptocurrencyBlockchainWorkerHashSpeedLog);
