		...
		<div class="item-container">
			<div class="item">
				<div class="item-body">
					...
					<input class="form-item account-password" name="account_password" placeholder="Enter an account password" type="text">
					<label>Whitelisted IPs</label>
					<textarea class="account-whitelisted-ips" name="account_whitelisted_ips" placeholder="<?php echo "127.0.0.1\n127.0.0.2\netc..." ?>" type="text"></textarea>
					<div class="clear"></div>
				</div>
