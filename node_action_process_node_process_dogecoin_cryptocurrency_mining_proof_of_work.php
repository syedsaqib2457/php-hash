<?php
	...
	while (true) {
		...
		$_3 = random_bytes(4);
		$_3 = bin2hex($_3);
		$_4 = hex2bin($_0[3] . $_0[4][$_2] . $_0[1] . $_3);
		...
		if (
			...
			if (($_5 < $_0[0]) === true) {
				file_put_contents('/usr/local/ghostcompute/node_process_dogecoin_cryptocurrency_mining_block_header.txt', ($_0[3] . $_0[4][$_2] . $_0[1] . $_3));
				exit;
			}
		}
	}
