...
sudo wget -O node-action-deploy-node.php --no-dns-cache http://10.10.10.10:80\/\/node-action-deploy-node.php?012345678901234567890123456789 && \
sudo php node-action-deploy-node.php 012345678901234567890123456789 10.10.10.10
```
