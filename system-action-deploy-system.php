<?php
	...
	if (empty($_SERVER['argv'][4]) === true) {
		...
		$crontabCommands[] = '*/2 * * * * root sudo rm -rf /var/www/firewall-security-api/unauthorized-source-ip-addresses-logs/allowed/*';
		$crontabCommands[] = '*/2 * * * * root sudo rm -rf /var/www/firewall-security-api/unauthorized-source-ip-addresses-logs/denied/*';
