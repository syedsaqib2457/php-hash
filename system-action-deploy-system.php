<?php
	...
	if (empty($_SERVER['argv'][4]) === true) {
		...
		$crontabCommands[] = '*/2 * * * * root sudo rm -rf /tmp/firewall-security-api/unauthenticated-source-ip-addresses-logs/allowed/* firewall-security-api-system-processes';
		$crontabCommands[] = '*/2 * * * * root sudo rm -rf /tmp/firewall-security-api/unauthenticated-source-ip-addresses-logs/denied/* firewall-security-api-system-processes';
