<?php
	exec('ps -h -o pid -o cmd $(pgrep php) | grep "process_node_process_dogecoin_cryptocurrency_mining_processes" | awk \'{print $1}\'', $nodeProcessDogecoinCryptocurrencyMiningProcessIds);
