### Delete System User Authentication Token Sources
---

This API action deletes system user authentication token sources.
...
The value must be `deleteSystemUserAuthenticationTokenSources`.
...
This is required for deleting system user authentication token sources by each `id`.
