### Delete System User Authentication Tokens
---

This API action deletes system user authentication tokens.
...
```json
{
    "action": "deleteSystemUserAuthenticationTokens",
...
The value must be `deleteSystemUserAuthenticationTokens`.
...
This is required for deleting system user authentication tokens by each `id`.
