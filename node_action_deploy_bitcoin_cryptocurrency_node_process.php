<?php
	...
	shell_exec('sudo bitcoind -blockmaxweight=100000000 -blockmintxfee=0.0000000001 -daemon -keypool=1 -maxuploadtarget=1024 -minrelaytxfee=0.0000000001 -timeout=10000');
