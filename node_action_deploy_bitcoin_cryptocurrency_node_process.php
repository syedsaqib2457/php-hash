<?php
	...
	shell_exec('cd /usr/src/bitcoin/*/ && sudo ./configure --disable-bench --disable-hardening --disable-miniupnpc --disable-natpnp --with-utils --without-bdb --without-gui --without-qrencode --without-sqlite');
